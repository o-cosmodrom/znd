...
function loadPage(url, element, callBack) 
{
    ...
    { 
        ...
        { 
            ...
            console.dir(_jSon[0], "section")
            // agora tem que pegar a primera linha, o id - titulo - descricao.
            // e criar um search com esses dados.. caso mude nos dbs online
            // ai vai acessar _jSon[0][col1] = aonde col1 vai ser "id"
        }
    }
    else 
    {        
...
var _testeDB = "https://script.google.com/macros/s/AKfycbzpcoDkqxBTdTZ_AsFe5gom-aSE6npGtMlPWF9zq0UtBdRVHCz8f046scoPW2Ee2O9t/exec"
//loadPage(_tDb)
